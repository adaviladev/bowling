...
describe("Game Scoring", () => {
  ...
  it("should_score_a_game_of_3_and_5_as_8", () => {
    const frames = [
      Factory.make("Frame", {
        rolls: [Factory.make("Roll", { pins: 3 }), Factory.make("Roll", { pins: 5 })]
      }),
      ...Factory.make(
        "Frame",
        {
  ...
  it("should_give_a_one_roll_bonus_for_a_spare", () => {
    const frames = [
      Factory.make("Frame", {
        rolls: [Factory.make("Roll", { pins: 3 }), Factory.make("Roll", { pins: 7 })]
      }),
      Factory.make("Frame", {
        rolls: [Factory.make("Roll", { pins: 3 }), Factory.make("Roll", { pins: 0 })]
      }),
      ...Factory.make(
        "Frame",
        {
